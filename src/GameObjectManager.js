...
function GameObjectManager()
{
    ...
    */
    this.startupGameObjectManager = function()
    {
		...
		document.onmousedown = function(event){g_GameObjectManager.mouseDown(event);}
		document.onmouseup = function(event){g_GameObjectManager.mouseUp(event);}
		document.onmousemove = function(event){g_GameObjectManager.mouseMove(event);}
    ...
    */
    this.draw = function ()
    {
        ...
        if (this.canvasSupported && this.resourcesLoaded)
        {
			...
			g_ApplicationManager.updateConsole();
